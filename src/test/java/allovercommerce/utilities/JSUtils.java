...
public class JSUtils {
    ...
    public static void clickElementByJS(WebElement element) {
        JavascriptExecutor jsexecutor = ((JavascriptExecutor) allovercommerce.utilities.Driver.getDriver());
    ...
    public static void scrollAllUpByJS(){
        JavascriptExecutor js = (JavascriptExecutor) allovercommerce.utilities.Driver.getDriver();
    ...
    public static void changeColor(String color, WebElement element) {
        JavascriptExecutor javascriptExecutor = ((JavascriptExecutor) allovercommerce.utilities.Driver.getDriver());
    ...
    public static void executeJScommand(WebElement element, String command) {
        JavascriptExecutor jse = (JavascriptExecutor) allovercommerce.utilities.Driver.getDriver();
