...
public class JSUtils {
    ...
    public static void clickElementByJS(WebElement element) {
        JavascriptExecutor jsexecutor = ((JavascriptExecutor) allover_commerce.utilities.Driver.getDriver());
    ...
    public static void scrollAllUpByJS(){
        JavascriptExecutor js = (JavascriptExecutor) allover_commerce.utilities.Driver.getDriver();
    ...
    public static void changeColor(String color, WebElement element) {
        JavascriptExecutor javascriptExecutor = ((JavascriptExecutor) allover_commerce.utilities.Driver.getDriver());
    ...
    public static void executeJScommand(WebElement element, String command) {
        JavascriptExecutor jse = (JavascriptExecutor) allover_commerce.utilities.Driver.getDriver();
